...
static CGFloat const kConerRadius = 16.f;

@interface WYMPresentationController()<UIViewControllerAnimatedTransitioning>
...
@implementation WYMPresentationController
...
//        self.presentationWrappingView = presentationWrapperView;
        ...
        //上面的圆角
        UIView *presentationRoundedCornerView = [[UIView alloc] initWithFrame:UIEdgeInsetsInsetRect(presentationWrapperView.bounds, UIEdgeInsetsMake(0, 0, -kConerRadius, 0))];
        presentationRoundedCornerView.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
        presentationRoundedCornerView.layer.cornerRadius = kConerRadius;
        ...
        //被呈现的视图
        UIView *presentedViewControllerWrapperView = [[UIView alloc] initWithFrame:UIEdgeInsetsInsetRect(presentationRoundedCornerView.bounds, UIEdgeInsetsMake(0, 0, kConerRadius, 0))];
